...
describe('build-and-tag-action', () => {
  ...
  it('does not update the major & minor ref if the tag name meets a prerelease', async () => {
    nock('https://api.github.com')
      .patch('/repos/JasonEtco/test/git/refs/tags%2Fv2.0.0-alpha.0')
      .reply(200)
      .patch('/repos/JasonEtco/test/git/refs/tags%2Falpha')
      .reply(200)      
      .get('/repos/JasonEtco/test/git/matching-refs/tags%2Fv2.0.0-alpha.0')
      .reply(200, [{ ref: 'tags/v2.0.0-alpha.0' }])
      .get('/repos/JasonEtco/test/git/matching-refs/tags%2Falpha')
      .reply(200, [{ ref: 'tags/alpha' }])      
      .post('/repos/JasonEtco/test/git/commits')
      .reply(200, { commit: { sha: '123abc' } })
      .post('/repos/JasonEtco/test/git/trees')
      .reply(200)
    ...
    tools.context.event = 'pull_request'
    process.env.INPUT_TAG_NAME = 'v2.0.0-alpha.0'
